...
We already have some notions of curvature by the differences between Euclidean and more general spaces. For example, whether or not parallel transport leaves vectors unchanged on a closed loop. The Riemann tensor will 
